          ...
          <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
            {isEditing ? (
              <input
                ...
                onChange={(e) =>
                  updateBottomFooter("copyright", e.target.value)
                }
                  ...
                  {isEditing ? (
                    <div className='flex items-center'>
                      <input
                        value={link.name}
                        onChange={(e) =>
                          updateBottomFooterLink(index, "name", e.target.value)
                        }
                      ...
                      <input
                        value={link.href}
                        onChange={(e) =>
                          updateBottomFooterLink(index, "href", e.target.value)
                        }
                        className='text-gray-400 bg-transparent border-b w-32 mr-2'
                      />
                      <Button
