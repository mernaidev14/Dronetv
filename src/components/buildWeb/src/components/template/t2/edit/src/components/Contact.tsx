        ...
        >
          ...
          >
            {isEditing ? (
              ...
              <h2 className="text-3xl md:text-4xl text-foreground mb-4">{header.title}</h2>
            )}
          </motion.div>
          <motion.div
            ...
            {isEditing ? (
              <div className="flex flex-col items-center">
                <input
                  ...
                  onChange={(e) => setHeader({...header, descriptionPart1: e.target.value})}
                  className="text-lg text-muted-foreground border-b bg-transparent w-full text-center mb-2"
                />
                <input
                  value={header.descriptionPart2}
                  onChange={(e) => setHeader({...header, descriptionPart2: e.target.value})}
                ...
                <input
                  ...
                  onChange={(e) => setHeader({...header, descriptionPart3: e.target.value})}
              ...
              <>
                ...
                >
                  <span className="text-lg text-red-accent font-semibold">{header.descriptionPart2}</span>
                </motion.span>
                <span className="text-lg text-muted-foreground">{header.descriptionPart3}</span>
              </>
            )}
          </motion.div>
        </motion.div>
                  ...
                  {isEditing ? (
                    ...
                    <>
                      <motion.div
                        ...
                        transition={{ duration: 2, repeat: Infinity }}
                      >
                        <h4 className="font-bold mb-2 text-primary-foreground">{cta.title}</h4>
                      </motion.div>
