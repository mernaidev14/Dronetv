...
export default function Contact({onStateChange}) {
  ...
  const [contactSection, setContactSection] = useState({
    header: {
      title: "Get In Touch",
      descriptionPart1: "Ready to transform your business? Let's start a conversation about how we can help you achieve your goals with our",
  ...
  const updateContactInfo = (idx, field, value) => {
    setContactSection(prev => ({
      ...prev,
      contactInfo: prev.contactInfo.map((c, i) => (i === idx ? { ...c, [field]: value } : c))
    }));
  };
          ...
          >
            {isEditing ? (
              <input
                ...
                onChange={(e) => setContactSection(prev => ({
                  ...prev,
              ...
              <h2 className="text-3xl md:text-4xl text-foreground mb-4">{contactSection.header.title}</h2>
            )}
          </motion.div>
          <motion.div
            ...
            {isEditing ? (
              <div className="flex flex-col items-center">
                <input
                  ...
                  onChange={(e) => setContactSection(prev => ({
                    ...prev,
                    header: {...prev.header, descriptionPart1: e.target.value}
                  }))}
                ...
                <input
                  ...
                  onChange={(e) => setContactSection(prev => ({
                    ...prev,
                    header: {...prev.header, descriptionPart2: e.target.value}
                  }))}
                ...
                <input
                  ...
                  onChange={(e) => setContactSection(prev => ({
                    ...prev,
                    header: {...prev.header, descriptionPart3: e.target.value}
                  }))}
              ...
              <>
                ...
                >
                  <span className="text-lg text-red-accent font-semibold">{contactSection.header.descriptionPart2}</span>
                </motion.span>
                <span className="text-lg text-muted-foreground">{contactSection.header.descriptionPart3}</span>
              </>
            )}
          </motion.div>
        </motion.div>
                        ...
                        <div className="w-full">
                          {isEditing ? (
                            <>
                              ...
                              <input
                                value={info.primary}
                                onChange={(e) => updateContactInfo(index, "primary", e.target.value)}
                                className="text-muted-foreground border-b bg-transparent w-full mb-1"
                              />
                              <input
                                value={info.secondary}
                                onChange={(e) => updateContactInfo(index, "secondary", e.target.value)}
                  ...
                  {isEditing ? (
                    ...
                    <>
                      <motion.div
                        ...
                        transition={{ duration: 2, repeat: Infinity }}
                      >
                        <h4 className="font-bold mb-2 text-primary-foreground">{contactSection.cta.title}</h4>
                      </motion.div>
                  ...
                  >
                    <Button className="bg-red-accent text-white hover:bg-red-accent/90 font-bold shadow-lg">
                      <span className="font-bold text-white">
                        {isEditing ? contactSection.cta.buttonText : "Book Free Consultation"}
                      </span>
                    </Button>
                  </motion.div>
                </CardContent>
