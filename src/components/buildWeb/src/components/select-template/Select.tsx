...
import { FiCheck, FiArrowRight, FiEye, FiStar, FiExternalLink } from 'react-icons/fi';
  ...
  const templates = [
    {
      ...
      imgpath: '',
      description: 'Clean design with yellow hero section perfect for creative professionals',
      features: ['Yellow Hero Section', 'Testimonials', 'Contact Form', 'Responsive Design'],
      path: '#',
      rating: 4.8,
    ...
    },
    {
      ...
      description: 'Blue layout with timeline skills ideal for job seekers and professionals',
      features: ['Yellow Hero Section', 'Testimonials', 'Contact Form', 'Responsive Design'],
      path: '/template/t2',
      rating: 4.5,
    ...
    <div className="max-w-6xl bg-white my-16 mx-auto px-4 py-8">
      ...
      >
        ...
        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          Select from our professionally designed templates to create a stunning portfolio that showcases your work
        </p>
      </motion.div>
            ...
            >
              ...
              <div className="flex gap-3 mt-4">
                ...
                >
                  ...
                  <FiArrowRight className={`w-4 h-4 transition-transform ${isActive ? 'transform group-hover:translate-x-1' : ''}`} />
                </motion.button>
      ...
      >
        <p className="text-gray-600 mb-2">
          💡 Can't decide? Both templates are fully customizable after selection!
        </p>
