...
const PortfolioTemplate2: React.FC = () => {
  ...
  const formattedTestimonials = {
    ...
    ...Object.fromEntries(
      Object.entries(apiData).filter(([key]) => key.startsWith('testimonials_')))
  };
  ...
  const formattedBlogPosts = {
    ...
    ...Object.fromEntries(
      Object.entries(apiData).filter(([key]) => key.startsWith('blogPosts_')))
  };
  ...
  if (apiData.socialLinks) {
    Object.entries(apiData.socialLinks).forEach(([key, val]) => {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        {apiData.blogPosts && apiData.blogPosts.length > 0 && (
